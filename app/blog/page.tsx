          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {posts.map((p, i) => (
              <Reveal key={p.title} delay={0.08 * i}>
                <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-brand-green/10 bg-surface shadow-soft dark:ring-1 dark:ring-white/10 transition-all duration-300 hover:-translate-y-2 hover:border-brand-green/30 hover:shadow-lift">
                  <div className={`relative flex h-44 items-end bg-gradient-to-br ${p.tint} p-5`}>
                    ...
                    <span className="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-white/20 text-white ring-1 ring-white/25 backdrop-blur transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-6">
                      <p.icon className="h-7 w-7" />
                    </span>
                  </div>
                  <div className="flex flex-1 flex-col p-6">
                    <div className="flex items-center gap-3 font-mono text-[11px] font-semibold uppercase tracking-[0.18em]">
                      <span className="text-brand-green-dark">{p.tag}</span>
                      <span className="flex items-center gap-1.5 text-brand-ink/40">
                        <CalendarDays className="h-3.5 w-3.5" />
                        {p.date}
                      </span>
                    </div>
                    <h2 className="mt-3 font-display text-xl font-bold leading-snug text-brand-ink transition-colors group-hover:text-brand-green-dark">
                      {p.title}
                    </h2>
        ...
        <div className="mx-auto grid w-full max-w-7xl items-start gap-12 px-5 sm:px-8 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="space-y-6 lg:sticky lg:top-28">
            ...
            <Reveal direction="left">
              <div className="rounded-3xl bg-gradient-to-br from-brand-blue via-brand-blue-soft to-brand-teal p-8 text-white shadow-lift">
            ...
            <Reveal direction="left" delay={0.1}>
              <div className="rounded-3xl bg-surface p-6 shadow-soft ring-1 ring-black/5 dark:ring-white/10">
                ...
                <div className="mt-4 space-y-3">
                  <a
                    ...
                    className="group flex items-center gap-3 rounded-2xl bg-[#1877F2]/10 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#1877F2]/20"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex items-center gap-3 rounded-2xl bg-[#0A66C2]/10 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#0A66C2]/20"
                  >
